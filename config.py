...
class AppConfig:
    ...
    question_read_min_sec: float = _get_float("QUESTION_READ_MIN_SEC", 2.8)
    question_read_max_sec: float = _get_float("QUESTION_READ_MAX_SEC", 5.0)
    question_read_base_sec: float = _get_float("QUESTION_READ_BASE_SEC", 2.0)
    question_read_word_rate_sec: float = _get_float("QUESTION_READ_WORD_RATE_SEC", 0.16)
    question_fade_in_sec: float = _get_float("QUESTION_FADE_IN_SEC", 0.75)
    question_fade_out_sec: float = _get_float("QUESTION_FADE_OUT_SEC", 0.85)
    question_to_answer_pause_sec: float = _get_float("QUESTION_TO_ANSWER_PAUSE_SEC", 0.6)
