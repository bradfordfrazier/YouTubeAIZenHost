...
def test_resizable_window():
    ...
    try:
        # 1. Test 16:9 Landscape Mode (1920x1080 canvas, 960x540 scaled desktop window)
        config.visualizer_aspect_ratio = "16:9"
        config.visualizer_native_window = False
        vis_16x9 = Visualizer(width=1920, height=1080)
        assert vis_16x9.window_size == (960, 540), f"Expected 16:9 initial window size (960, 540), got {vis_16x9.window_size}"
        ...
        print("-> 16:9 Landscape (960x540 desktop window -> 1920x1080 stream) test passed!")
