...
class Visualizer:
    ...
    def _draw_promo_callout_overlay(self, dt: float):
        ...
        if self.is_vertical:
            ...
            # Position just below the avatar outer circle (bottom at cy + 210 = 664)
            target_y = self.core_cy + 220
            start_y = target_y - 40
            cur_x = target_x
            ...
            target_x = (self.width - card_w) // 2
            # Position just below the avatar outer circle (bottom at cy + 210 = 468)
            target_y = self.core_cy + 220
            start_x = -card_w - 60
